            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <?php if(isset($_GET['eid']) && $_GET['eid'] != ''){?>
                        <li class="breadcrumb-item"><a href= "{{route('restaurants.orders',$_GET['eid'])}}" >{{trans('lang.order_plural')}}</a></li>
                    <?php }else{ ?>
        ...
        if (products) {
          ...
          if(specialDiscount != undefined){
            ...
            try{
             ...
             if(!isNaN(tax) && tax!=0){
                if(currencyAtRight){
                  html=html+'<tr><td class="label">{{trans("lang.tax")}}</td><td class="deliveryCharge">+'+tax+''+currentCurrency+'('+taxlabel+' '+snapshotsProducts.taxSetting.tax+' '+taxlabeltype+')</td></tr>';
                  $('.total_tax_amount').text("+ " + tax+" " +currentCurrency+' ('+taxlabel+' '+snapshotsProducts.taxSetting.tax+' '+taxlabeltype+')');
                }else{
                  html=html+'<tr><td class="label">{{trans("lang.tax")}}</td><td class="deliveryCharge">+'+currentCurrency+tax+'('+taxlabel+' '+snapshotsProducts.taxSetting.tax +' '+taxlabeltype+')</td></tr>';
